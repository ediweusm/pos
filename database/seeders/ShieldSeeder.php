...
class ShieldSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $tenants = '[]';
        // Never seed predictable production accounts. Bootstrap administrators through
        // a separately controlled deployment process instead.
        $users = '[]';
        $userTenantPivot = '[]';
        ...
        // The generated export previously gave cashiers every permission in the
        // application. Keep their access limited to the POS, their own shifts,
        // and customer lookup/registration.
        static::syncCashierPermissions();
    ...
    protected static function syncCashierPermissions(): void
    {
        $roleModel = Utils::getRoleModel();
        $permissionModel = Utils::getPermissionModel();

        $kasir = $roleModel::firstOrCreate([
            'name' => 'Kasir',
            'guard_name' => 'web',
        ]);
