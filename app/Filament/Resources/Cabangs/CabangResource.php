...
class CabangResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Cabang Toko';
    protected static ?string $pluralModelLabel = 'Cabang Toko';
    protected static string|\UnitEnum|null $navigationGroup = 'Master Logistik';
    protected static ?int $navigationSort = 1; // Taruh paling atas di logistik
